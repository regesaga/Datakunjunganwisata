...
<div class="col-lg-12">
    <div class="row mb-3">
        <div class="col-xl-6 col-sm-6 py-2">
            <a href="{{ route('account.guide.user-guide') }}">
...
<div class="col-lg-12" >
    <div class="card" >
            ...
            <div class="card-body">
                <a class="btn btn-outline-success btn-sm" href="{{ route("account.guide.banerpromo.create") }}">
                                    ...
                                    @foreach ($banerpromo as $banerpromo)
                                        ...
                                        <td width="25%">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a class="btn btn-outline-success btn-sm" href="{{ route('account.guide.banerpromo.show', $hash->encodeHex($banerpromo->id)) }}"><i class="fas fa-eye"></i>
                                                    Detail</a>
                                                <a class="btn btn-info" href="{{ route('account.guide.banerpromo.edit', $hash->encodeHex($banerpromo->id)) }}">
                                                    <i class="fas fa-edit"></i> Edit</a>

                                                <form action="{{ route('account.guide.banerpromo.destroy', $hash->encodeHex($banerpromo->id)) }}" method="POST" onsubmit="return confirm('{{ trans('anda yakin akan menghapus?') }}');" >
...
<script>
  ...
  let deleteButton = {
    ...
    url: "{{ route('account.guide.banerpromo.massDestroyBanerpromo') }}",
