...
<div class="col-12">
    ...
    <!-- Page Heading -->
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("account.guide.banerpromo.update", $hash->encodeHex($banerpromo->id)) }}"   enctype="multipart/form-data" >
                @method('PUT')
                @csrf
                <div class="row">
                    <div class="col-md-2">
                ...
                <a href="{{ route('account.guide.banerpromo.index') }}" class="btn btn-secondary btn-sm">Kembali</a>
