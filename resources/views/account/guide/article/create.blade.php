            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('account.guide.article.store')}}"  method="post" enctype="multipart/form-data" onsubmit="return validateForm()" >
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="deskripsi" rows="10" name="konten">{{old('konten')}}</textarea>
                                @error('konten')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <a  href="{{ route('account.guide.article.index') }}" class="btn btn-secondary btn-sm">Kembali</a>
                        </form>
