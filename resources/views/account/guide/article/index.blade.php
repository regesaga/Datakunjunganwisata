...
@section('content')
                <div class="col-lg-12">
                    <div class="card">
                            ...
                            <div class="card-body">
                                <a class="btn btn-success" href="{{ route("account.guide.article.create") }}">
                                    ...
                                    @foreach ($article as $article)
                                        ...
                                        <td width="25%">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a class="btn btn-success" href="{{ route('account.guide.article.show', $hash->encodeHex($article->id)) }}"><i class="fas fa-eye"></i>
                                                    Detail</a>
