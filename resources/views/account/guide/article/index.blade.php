...
@section('content')
                <div class="col-lg-12">
                    <div class="card">
                            ...
                            <div class="card-body">
                                <a class="btn btn-outline-success btn-sm" href="{{ route("account.guide.article.create") }}">
                                    ...
                                    @foreach ($article as $article)
                                        ...
                                        <td width="25%">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a class="btn btn-outline-success btn-sm" href="{{ route('account.guide.article.show', $hash->encodeHex($article->id)) }}"><i class="fas fa-eye"></i>
                                                    Detail</a>
                                                <a class="btn btn-info" href="{{ route('account.guide.article.edit', $hash->encodeHex($article->id)) }}">
                                                    <i class="fas fa-edit"></i> Edit</a>

                                                <form action="{{ route('account.guide.article.destroy', $hash->encodeHex($article->id)) }}" method="POST" onsubmit="return confirm('{{ trans('anda yakin akan menghapus?') }}');" >
