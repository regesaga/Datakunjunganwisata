...
@section('content')
  <div class="account-layout border">
    ...
    <div class="account-bdy p-3">
      <form action="{{ route('account.guide.company.update', $company->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mt-3">
          ...
          <a href="{{route('account.guide.user-guide')}}" class="btn primary-outline-btn">Cancel</a>
        </div>
      </form>
    </div>
  </div>
