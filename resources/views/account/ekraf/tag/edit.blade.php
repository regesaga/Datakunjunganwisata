    ...
    <div class="card">
        ...
        <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">edit</h1>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("account.ekraf.tag.update", $hash->encodeHex($tag->id)) }}"   enctype="multipart/form-data" >
                        @method('PUT')
                        @csrf
                        ...
                        <a href="{{ route("account.ekraf.tag.index") }}" class="btn btn-secondary ">Kembali</a>
                    </form>
                </div>
    </div>
</div>
