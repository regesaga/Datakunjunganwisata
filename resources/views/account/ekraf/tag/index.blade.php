...
<div class="col-lg-12">
    <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route("account.ekraf.tag.create") }}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Tambah Tag</a>
                                ...
                                @foreach ($tag as $tag)
                                    ...
                                    <td width="20%">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a class="btn btn-info" href="{{ route('account.ekraf.tag.edit', $hash->encodeHex($tag->id)) }}">
