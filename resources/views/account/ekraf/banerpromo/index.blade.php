...
<div class="col-lg-12" >
    <div class="card" >
            ...
            <div class="card-body">
                <a class="btn btn-success" href="{{ route("account.ekraf.banerpromo.create") }}">
                                    ...
                                    @foreach ($banerpromo as $banerpromo)
                                        ...
                                        <td width="25%">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a class="btn btn-success" href="{{ route('account.ekraf.banerpromo.show', $hash->encodeHex($banerpromo->id)) }}"><i class="fas fa-eye"></i>
                                                    Detail</a>
