...
<div class="col-lg-12">
    <div class="row mb-3">
        <div class="col-xl-6 col-sm-6 py-2">
            <a href="{{ route('account.ekraf.user-ekraf') }}">
          ...
          <a href="">
            <div class="card dashboard-card text-white h-100 shadow">
                <div class="card-body bg-info">
                    ...
                    <h6 class="text-uppercase">Produk</h6>
                    <h1 class=""></h1>
                </div>
            </div>
          </a>
...
<div class="col-lg-12" >
    <div class="card" >
            ...
            <div class="card-body">
                <a class="btn btn-outline-success btn-sm" href="{{ route("account.ekraf.banerpromo.create") }}">
                                    ...
                                    @foreach ($banerpromo as $banerpromo)
                                        ...
                                        <td width="25%">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a class="btn btn-outline-success btn-sm" href="{{ route('account.ekraf.banerpromo.show', $hash->encodeHex($banerpromo->id)) }}"><i class="fas fa-eye"></i>
                                                    Detail</a>
                                                <a class="btn btn-info" href="{{ route('account.ekraf.banerpromo.edit', $hash->encodeHex($banerpromo->id)) }}">
                                                    <i class="fas fa-edit"></i> Edit</a>

                                                <form action="{{ route('account.ekraf.banerpromo.destroy', $hash->encodeHex($banerpromo->id)) }}" method="POST" onsubmit="return confirm('{{ trans('anda yakin akan menghapus?') }}');" >
...
<script>
  ...
  let deleteButton = {
    ...
    url: "{{ route('account.ekraf.banerpromo.massDestroyBanerpromo') }}",
