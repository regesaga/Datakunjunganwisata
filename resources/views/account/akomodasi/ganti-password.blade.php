...
@section('content')
  <div class="account-layout  border">
    ...
    <div class="account-bdy p-3">
      <form action="{{route('account.akomodasi.changePassword')}}" method="POST">
        @csrf
        @method('PUT')
        <div class="form-group">
          <div class="input-group mb-3">
          <input id="password_hash"  type="password"  placeholder="Current Password *" class="form-control @error('current_password') is-invalid @enderror" name="current_password" value="{{ old('current_password') }}" required>
        ...
        <div class="form-group">
          <div class="input-group mb-3">
          <input id="passwordnew"  type="password" placeholder="New Password*" class="form-control @error('new_password') is-invalid @enderror" name="new_password" value="{{ old('new_password') }}" required>
          <span class="input-group-text" id="togglePassword" onclick="togglePasswordNewVisibility()">
        ...
        <div class="form-group">
          <div class="input-group mb-3">
          <input id="password_confirmation"  type="password" placeholder="Confirm Password *" class="form-control @error('confirm_password') is-invalid @enderror" name="confirm_password" value="{{ old('confirm_password') }}" required>
