                                ...
                                <tr data-entry-id="{{ $room->id }}" >
                                    ...
                                    <td>
                                        <div class="btn-group" aria-label="Basic example">
                                            <a class="btn btn-xs btn-primary" href="{{ route('account.akomodasi.room.show', $hash->encodeHex($room->id)) }}">
                                                Detail
                                            </a>

                                            <a class="btn btn-xs btn-info" href="{{ route('account.akomodasi.room.edit', $hash->encodeHex($room->id)) }}">
                                                Edit  
                                            </a>

                                            <form action="{{ route('account.akomodasi.room.destroy', $hash->encodeHex($room->id)) }}" method="POST" onsubmit="return confirm('{{ trans('anda yakin akan menghapus?') }}');" >
