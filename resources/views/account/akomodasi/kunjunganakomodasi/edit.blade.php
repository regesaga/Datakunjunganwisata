...
<section class="content-header">
    <div class="container-fluid">
        <form action="{{ route('account.akomodasi.kunjunganakomodasi.update', $tanggal_kunjungan) }}" method="POST">
            @csrf
            @method('PUT')  <!-- Ganti dari PATCH ke PUT -->
            <div class="form-header">
                <h1  style="text-align: center; text-transform: uppercase;">Edit Data Kunjungan</h1>
                <h2  style="text-align: center; text-transform: uppercase;">{{ $akomodasi->namaakomodasi }}</h2>
                @if (session('warning'))
