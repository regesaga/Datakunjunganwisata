                                ...
                                <tr data-entry-id="{{ $even->id }}" >
                                    ...
                                    <td>
                                        <div class="btn-group" aria-label="Basic example">
                                            <a class="btn btn-xs btn-primary" href="{{ route('account.akomodasi.even.show', $hash->encodeHex($even->id)) }}">
                                                Detail
                                            </a>
                                            ...
                                            <form action="{{ route('account.akomodasi.even.destroy', $hash->encodeHex($even->id)) }}" method="POST" onsubmit="return confirm('{{ trans('anda yakin akan menghapus?') }}');" >
