...
@section('content')
                <div class="col-12">
                    <div class="card">
                        ...
                        <form method="POST" action="{{ route("account.akomodasi.even.update", $hash->encodeHex($even->id)) }}"   enctype="multipart/form-data" >
                            @method('PUT')
                            @csrf
...
Dropzone.options.photosDropzone = {
    url: '{{ route('account.akomodasi.even.storeMedia') }}',
    maxFilesize: 2, // MB
