    ...
    <div class="account-bdy p-3">
        <div class="row mb-3">
          <div class="col-xl-3 col-sm-6 py-2">
            <a href="{{ route('account.akomodasi.reserv') }}">
          ...
          <div class="col-xl-3 col-sm-6 py-2">
            @if($akomodasi)
            <a href="{{ route('account.akomodasi.room.index') }}">
                @else
            <a href="">
                @endif
              <div class="card dashboard-card text-white  h-100 shadow">
          ...
          <div class="col-xl-3 col-sm-6 py-2">
            <a href="{{ route('account.akomodasi.even.index') }}">
              <div class="card dashboard-card text-white h-100 shadow">
          ...
          <div class="col-xl-3 col-sm-6 py-2">
              <a href="{{ route('account.akomodasi.banerpromo.index') }}">
                <div class="card dashboard-card text-white h-100 shadow">
                  ...
                  <div class="card">
                      <div class="card-body">
                          ...
                          <div class="mb-3 d-flex">
                            @if(!$company)
                            <a href="{{route('account.akomodasi.company.create')}}" class="btn primary-btn mr-2">Isi Detail Perusahaan</a>
                            @else
                            <a href="{{route('account.akomodasi.company.edit')}}" class="btn secondary-btn mr-2">Edit Perusahaan</a>
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3 d-flex">
                                    @if(!$akomodasi)
                                        <a href="{{route('account.akomodasi.akomodasi.create')}}" class="btn primary-btn mr-2">Isi Detail Akomodasi</a>
                                    @else
                                        <a href="{{route('account.akomodasi.akomodasi.edit')}}" class="btn secondary-btn mr-2">Edit Akomodasi</a>
                                    @endif
                                </div>
                                @if($akomodasi)
                                    <div class="row">
