...
<div class="col-lg-12">
    <div class="row mb-3">
        <div class="col-xl-6 col-sm-6 py-2">
            <a href="{{ route('account.akomodasi.user-akomodasi') }}">
                        ...
                        <tr>
                            ...
                            {{-- <td>
                                <a class="btn btn-xs btn-info"
                                    href="{{ route('account.akomodasi.fasilitas.edit', $hash->encodeHex($fasilitasItem->id)) }}">
                                    Ubah
                                </a>
                                <form action="{{ route('account.akomodasi.fasilitas.destroy', $fasilitasItem->id) }}"
...
<script>
  ...
  let deleteButton = {
    ...
    url: "{{ route('account.akomodasi.fasilitas.massDestroy') }}",
