                                ...
                                <tr data-entry-id="{{ $kulinerproduk->id }}" >
                                    ...
                                    <td>
                                        <div class="btn-group" aria-label="Basic example">
                                            <a class="btn btn-xs btn-primary" href="{{ route('account.wisata.kulinerproduk.show', $hash->encodeHex($kulinerproduk->id)) }}">
                                                Detail
                                            </a>

                                            <a class="btn btn-xs btn-info" href="{{ route('account.wisata.kulinerproduk.edit', $hash->encodeHex($kulinerproduk->id)) }}">
                                                Edit  
                                            </a>

                                            <form action="{{ route('account.wisata.kulinerproduk.destroy', $hash->encodeHex($kulinerproduk->id)) }}" method="POST" onsubmit="return confirm('{{ trans('anda yakin akan menghapus?') }}');" >
