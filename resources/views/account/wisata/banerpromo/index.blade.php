...
<div class="col-lg-12" >
    <div class="card" >
            ...
            <div class="card-body">
                <a class="btn btn-outline-success btn-sm" href="{{ route("account.wisata.banerpromo.create") }}">
                                    ...
                                    @foreach ($banerpromo as $banerpromo)
                                        ...
                                        <td width="25%">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a class="btn btn-outline-success btn-sm" href="{{ route('account.wisata.banerpromo.show', $hash->encodeHex($banerpromo->id)) }}"><i class="fas fa-eye"></i>
                                                    Detail</a>
                                                <a class="btn btn-info" href="{{ route('account.wisata.banerpromo.edit', $hash->encodeHex($banerpromo->id)) }}">
                                                    <i class="fas fa-edit"></i> Edit</a>

                                                <form action="{{ route('account.wisata.banerpromo.destroy', $hash->encodeHex($banerpromo->id)) }}" method="POST" onsubmit="return confirm('{{ trans('anda yakin akan menghapus?') }}');" >
...
<script>
  ...
  let deleteButton = {
    ...
    url: "{{ route('account.wisata.banerpromo.massDestroyBanerpromo') }}",
