...
<div class="col-12">
    ...
    <!-- Page Heading -->
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("account.wisata.banerpromo.update", $hash->encodeHex($banerpromo->id)) }}"   enctype="multipart/form-data" >
                @method('PUT')
                @csrf
                <div class="row">
                    <div class="col-md-2">
                ...
                <a href="{{ route('account.wisata.banerpromo.index') }}" class="btn btn-secondary btn-sm">Kembali</a>
