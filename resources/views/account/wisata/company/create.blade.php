...
@section('content')
  <div class="account-layout border">
    ...
    <div class="account-bdy p-3">
     <form action="{{route('account.wisata.company.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mt-3">
          ...
          <a href="{{route('account.wisata.user-wisata')}}" class="btn primary-outline-btn">Cancel</a>
        </div>
      </form>
    </div>
  </div>
