...
<div class="col-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('account.wisata.guide.storeGuide')}}"  method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                @csrf
...
<script>
  ...
  if (deskripsi.trim() === "") {
    alert("Kegiatan harus diisi, Jika sudah diisi silahkan submit lagi");
    return false;
  }
