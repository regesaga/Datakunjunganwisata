        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <a class="btn btn-default" href="{{ route('account.wisata.guide.index') }}">
                            Kembali
                        </a>
                        <a class="btn btn-outline-primary" href="{{ route('account.wisata.guide.edit', $hash->encodeHex($guide->id)) }}">
                            Edit  
                        </a>
                    </div>
                </div>
