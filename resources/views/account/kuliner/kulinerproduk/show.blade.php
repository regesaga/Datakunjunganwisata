        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <a class="btn btn-default" href="{{ route('account.kuliner.kulinerproduk.index') }}">
                            Kembali
                        </a>
                        <a class="btn btn-outline-primary" href="{{ route('account.kuliner.kulinerproduk.edit', $hash->encodeHex($kulinerproduk->id)) }}">
                            Edit  
                        </a>
                    </div>
                </div>
