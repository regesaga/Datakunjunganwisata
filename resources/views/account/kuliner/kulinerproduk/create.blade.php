...
@section('content')
            ...
            <form action="{{route('account.kuliner.kulinerproduk.storeKulinerproduk')}}"  method="post" enctype="multipart/form-data"  onsubmit="return validateForm()">
                @csrf
...
url: '{{ route('account.kuliner.kulinerproduk.storeMedia') }}',
maxFilesize: 2, // MB
