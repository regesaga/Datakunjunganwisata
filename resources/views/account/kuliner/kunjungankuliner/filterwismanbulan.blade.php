...
<section class="content-header">
    <div class="container-fluid">
        ...
        <form method="GET" action="{{ route('account.kuliner.kunjungankuliner.filterwismanbulan') }}">
            <div class="row">
                <div class="col-lg-4">
        ...
        <div class="card">
            <div class="card-header">
                <a   style="text-align: center; text-transform: uppercase;" class="btn btn-outline-success btn-sm" href="{{ route("account.kuliner.kunjungankuliner.createwisnu") }}">
                    Tambah Data
                </a>
                ...
                <thead>
                    <th colspan="{{ 3 +  (count($wismannegara) * 2) }}">
                        <h2 style="text-align: center; text-transform: uppercase;">
                            Data Kunjungan Wisatawan Mancanegara {{$kuliner->namakuliner}} Tahun {{ $tahun }} Bulan{{ $bulanIndo[(int)$bulan] }}
                        </h2>
                    </th>
                    <tr>
