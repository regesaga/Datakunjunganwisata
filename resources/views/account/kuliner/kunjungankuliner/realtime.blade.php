...
<section class="content-header">
    ...
    <!-- Filter Tanggal -->
    <form method="GET" action="{{ route('account.kuliner.kunjungankuliner.realtime') }}">
                ...
                <tr>
                    <th colspan="{{ 3 + (count($kelompok) * 2) + (count($wismannegara) * 2) }}">
                        <h2 style="text-align: center; text-transform: uppercase;">
                            @if ($filter == 'hari_ini')
                                DATA KUNJUNGAN {{ $kuliner->namakuliner }} HARI INI
                            @elseif ($filter == 'minggu_ini')
                                DATA KUNJUNGAN {{ $kuliner->namakuliner }} MINGGU INI
                            @elseif ($filter == 'bulan_ini')
                                DATA KUNJUNGAN {{ $kuliner->namakuliner }} BULAN INI
                            @endif
                        </h2>
                    </th>
                </tr>
