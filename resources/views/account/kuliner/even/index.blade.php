    ...
    <div class="row mb-3">
        ...
        <div class="col-xl-3 col-sm-6 py-2">
            ...
            <div class="card-header">
                <a class="btn btn-outline-success btn-sm" href="{{ route("account.kuliner.even.create") }}">
                    {{ trans('Tambah Event') }} 
                </a>
            </div>
                                ...
                                <tr data-entry-id="{{ $even->id }}" >
                                    ...
                                    <td>
                                        <div class="btn-group" aria-label="Basic example">
                                            <a class="btn btn-xs btn-primary" href="{{ route('account.kuliner.even.show', $hash->encodeHex($even->id)) }}">
                                                Detail
                                            </a>

                                            <a class="btn btn-xs btn-info" href="{{ route('account.kuliner.even.edit', $hash->encodeHex($even->id)) }}">
                                                Edit  
                                            </a>

                                            <form action="{{ route('account.kuliner.even.destroy', $hash->encodeHex($even->id)) }}" method="POST" onsubmit="return confirm('{{ trans('anda yakin akan menghapus?') }}');" >
...
<script>
  ...
  let deleteButton = {
    ...
    url: "{{ route('account.kuliner.even.massDestroy')}}",
