...
@section('content')
  <div class="account-layout border">
    ...
    <div class="account-bdy p-3">
     <form action="{{route('account.kuliner.company.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mt-3">
          <button type="submit" class="btn primary-btn">Isi detail Usaha</button>
          <a href="{{route('account.kuliner.user-kuliner')}}" class="btn primary-outline-btn">Cancel</a>
        </div>
      </form>
    </div>
  </div>
