...
<div class="col-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('account.kuliner.kuliner.storeKuliner')}}"  method="post" enctype="multipart/form-data"  onsubmit="return validateForm()">
                @csrf
                        ...
                        {{-- <iframe width="100%" height="500" src="https://maps.google.com/maps?q=kuningan&output=embed"></iframe>  --}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        Nama Kuliner 
                                        <div >
                                            <input class="form-control" type="text" name="namakuliner" id="namakuliner" value="{{ old('namakuliner', '') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <div >
                                            ...
                                            <select class="form-control" name="categorykuliner_id" value="{{ old('categorykuliner_id') }}" required>
...
<script>
   ...
   Dropzone.options.photosDropzone = {
           url: '{{ route('account.kuliner.kuliner.storeMedia') }}',
           maxFilesize: 2, // MB
