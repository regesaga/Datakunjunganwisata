            ...
            <a href="{{ route('account.kuliner.kulinerproduk.index') }}">
              <div class="card dashboard-card text-white  h-100 shadow">
                  <div class="card-body bg-info">
                      ...
                      <h6 class="text-uppercase">Jumlah Menu</h6>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3 d-flex">
                          @if(!$company)
                          <a href="{{route('account.kuliner.company.create')}}" class="btn primary-btn mr-2">Isi Detail Perusahaan</a>
                          @else
                          <a href="{{route('account.kuliner.company.edit')}}" class="btn secondary-btn mr-2">Edit Perusahaan</a>
          ...
          <div class="col-sm-12 col-md-12">
              <div class="card">
                  <div class="card-body">
                      ...
                      <div class="mb-3 d-flex">
                          @if(!$kuliner)
                          <a href="{{route('account.kuliner.kuliner.create')}}" class="btn primary-btn mr-2">Isi Detail Kuliner</a>
                      @else
                          <a href="{{route('account.kuliner.kuliner.edit')}}" class="btn secondary-btn mr-2">Edit Kuliner</a>
                      @endif
                      </div>
                      @if($kuliner)
                      <div class="row">
