            ...
            <nav class="navbar navbar-expand-md navbar-white bg-white border-bottom sticky-top" id="navbar">
              <div class="container">
                  ...
                  <li class="list-group-item list-group-item-action {{ request()->segment(2) == 'cek' ? 'active': ''}}">
                    <a href="{{ route('account.wisata.kunjunganwisata.dashboard') }}" class="account-nav-link">
          ...
          <nav class="navbar navbar-expand-md navbar-white bg-white border-bottom sticky-top" id="navbar">
            ...
            @if(isset($kuliner))
                  <li class="list-group-item list-group-item-action {{ request()->segment(2) == 'cek' ? 'active': ''}}">
                    <a href="{{ route('account.kuliner.kunjungankuliner.dashboard') }}" class="account-nav-link">
                      <i class="fas fa-search"></i> Data Kunjungan
                    </a>
                  </li>
                  @endif
