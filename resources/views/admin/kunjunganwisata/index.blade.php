            ...
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <select name="categorywisata_id" class="form-control select2">
                        <option style="text-align: center; text-transform: uppercase;" value="">SEMUA TEMPAT WISATA</option>
                        @foreach($kategoriWisata as $kategori)
                            <option style="text-align: center; text-transform: uppercase;" value="{{ $kategori->id }}" {{ request('categorywisata_id') == $kategori->id ? 'selected' : '' }}>{{ $kategori->category_name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-lg-3">
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        ...
                        <tr>
                            <th rowspan="3" style="text-align: left; text-transform: uppercase;">Wisata</th>
                            ...
                            <th colspan="2" style="text-align: center; text-transform: uppercase;">Wisata Mancanegara</th>
                        </tr>
                        <tr>
                            @foreach ($kelompok as $namaKelompok)
                                <th colspan="2" style="text-align: center; text-transform: uppercase;">{{ $namaKelompok->kelompokkunjungan_name }}</th>
                            @endforeach
                            <th colspan="2" style="text-align: center; text-transform: uppercase;">Total Wisata Mancanegara</th>
                        </tr>
                        <tr>
                            @foreach ($kelompok as $namaKelompok)
            ...
            <tr class="{{  $isZero ? 'bg-navy color-palette' : '' }}">
                                ...
                                <td>  <a  href="{{ route('admin.kunjunganwisata.indexeditkunjunganwisata', [
                                    ...
                                    'bulan' => $bulan,
                                    'tahun' => $tahun
                                ]) }}" style="text-align: center; text-transform: uppercase;">{{ $dataTanggal['wisata']->namawisata }}
