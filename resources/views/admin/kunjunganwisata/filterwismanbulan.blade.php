    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <a style="text-align: center; text-transform: uppercase;" class="btn btn-outline-success btn-sm" href="{{ route("admin.kunjunganwisata.createwisnu") }}">
                    Tambah Data
                </a>
            </div>
                ...
                <tbody>
                    @foreach ($kunjungan as $tanggal => $dataTanggal)
                        <tr>
                            ...
                            <td>
                                <a style="text-align: center; text-transform: uppercase;" class="btn btn-info btn-sm" href="{{ route('admin.kunjunganwisata.edit', ['wisata_id' => $hash->encode($wisata->id),'tanggal_kunjungan' => $tanggal]) }}">
                                    <i class="fas fa-pencil-alt"></i> Ubah
                                </a>
                                <a style="text-align: center; text-transform: uppercase;" href="{{ route('admin.kunjunganwisata.delete', ['wisata_id' => $hash->encode($wisata->id), 'tanggal_kunjungan' => $tanggal]) }}"
