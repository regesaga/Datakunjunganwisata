...
<section class="content-header">
    <div class="container-fluid">
        ...
        <form method="GET" action="{{ route('admin.kunjunganwisata.indexkunjunganwisatapertahun') }}">
            <div class="row">
                <div class="col-lg-3">
                    <label style="text-align: center; text-transform: uppercase;" for="wisata_id" class="form-label">Wisata</label>
        ...
        <tr class="{{  $isZero ? 'bg-navy color-palette' : '' }}">
                            <td>
                                @if($wisata_id)
    <a style="text-align: left; text-transform: uppercase;" href="{{ route('admin.kunjunganwisata.indexeditkunjunganwisata', [
