...
<section class="content-header">
    ...
    <!-- Filter Tanggal -->
    <form method="GET" action="{{ route('admin.datakunjungan.realtime') }}">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        Highcharts.chart('kunjunganChart', {
            ...
            title: {
                text: 'Grafik Total Kunjungan Per Tanggal'
            },
            xAxis: {
            ...
            yAxis: {
                title: {
                    text: 'Jumlah Total Kunjungan'
                }
            },
            series: [
                {
                    name: 'Total Wisata',
                    data: @json($totalWisata)
                },
                {
                    name: 'Total Kuliner',
                    data: @json($totalKuliner)
                },
                {
                    name: 'Total Akomodasi',
                    data: @json($totalAkomodasi)
                },
                {
                    name: 'Total Event',
                    data: @json($totalEvent)
                }
            ]
        });
    });
