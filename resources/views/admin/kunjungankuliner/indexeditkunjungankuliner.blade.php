                ...
                <div class="col-lg-3">
                    ...
                    <select name="categorykuliner_id" class="form-control select2">
                        ...
                        @foreach($kategoriKuliner as $kategori)
                            <option value="{{ $kategori->id }}" {{ request('categorykuliner_id') == $kategori->id ? 'selected' : '' }}>{{ $kategori->category_name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-lg-3">
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th rowspan="3" style="text-align: center;">Kuliner</th>
                    ...
                    <tbody>
                        @forelse ($kunjungan as $dataTanggal)
                            <tr>
                                ...
                                {{ $dataTanggal['kuliner']->namakuliner }}
                                </a>
                                <td>
