...
<section class="content-header">
    ...
    <div class="container-fluid">
       ...
       <form method="GET" action="{{ route('admin.kunjungankuliner.indexeditkunjungankuliner', [
        'kuliner_id' => $hash->encode($kuliner->first()->id)]) }}">
        <div class="row">
            <div class="col-lg-4">
        ...
        <div class="card">
            <div class="card-header">
                <a class="btn btn-outline-primary btn-sm" href="{{ route("admin.kunjungankuliner.createwisnu") }}">
                    Tambah Data
                </a>
                ...
                <thead>
                    <tr>
                        ...
                        <h2 style="text-align: center; text-transform: uppercase;">
                            INDEX Kunjungan {{$kuliner->first()->namakuliner}}
                ...
                <tbody>
                    @foreach ($kunjungan as $tanggal => $dataTanggal)
                        ...
                        <tr class="{{  $isZero ? 'bg-navy color-palette' : '' }}">
                            ...
                            <input type="hidden" id="kuliner_id" value="{{ $hash->encode($kuliner->first()->id) }}">
...
<script>
    ...
    $(document).on('click', '#btn-save', function() {
        ...
        $.ajax({
            url: '{{ route("admin.kunjungankuliner.storewisnuindex") }}',
            method: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
