...
<section class="content-header">
    <div class="container-fluid">
        ...
        <form method="GET" action="{{ route('admin.kunjungankuliner.indexkunjungankulinerpertahun') }}">
            <div class="row">
                <div class="col-lg-3">
                    <label style="text-align: center; text-transform: uppercase;" for="kuliner_id" class="form-label">Kuliner</label>
                    ...
                    <tr>
                        <th colspan="{{ 3 + (count($kelompok) * 2) + (count($wismannegara) * 2) }}">
                            <h2 style="text-align: center; text-transform: uppercase;">
                                ...
                                Data Kunjungan {{ $kulinerTerpilih ? $kulinerTerpilih->first()->namakuliner : 'Semua Tempat Kuliner' }} Tahun {{ $tahun }}
                            </h2>
        ...
        <tr class="{{  $isZero ? 'bg-navy color-palette' : '' }}">
                            <td>
                                @if($kuliner_id)
    <a style="text-align: left; text-transform: uppercase;" href="{{ route('admin.kunjungankuliner.indexeditkunjungankuliner', [
