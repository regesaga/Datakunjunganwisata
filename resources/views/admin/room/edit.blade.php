...
<main class="main">
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route("admin.room.update", $hash->encodeHex($room->id)) }}"   enctype="multipart/form-data" >
                    @method('PUT')
                    @csrf
                                ...
                                {{-- <iframe width="100%" height="500" src="https://maps.google.com/maps?q=kuningan&output=embed"></iframe>  --}}
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5 col-md-5">
                                                Nama Kamar 
                                                <div >
                                                    <input class="form-control" type="text" name="nama" id="nama"  value="{{ $room->nama }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2 col-md-2">
                                                ...
                                                <div >
                                                    <select class="form-control" name="akomodasi_id" value="{{ old('akomodasi_id') }}" required>
                                                        <option value="{{$room->akomodasi_id}}"  {{ $room->akomodasi_id!= "" ? 'selected' : '' }}>{{$room->akomodasi->namaakomodasi}}</option>
