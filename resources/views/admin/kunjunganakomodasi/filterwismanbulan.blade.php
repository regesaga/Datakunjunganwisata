...
<section class="content-header">
    <div class="container-fluid">
        ...
        <form method="GET" action="{{ route('admin.kunjunganakomodasi.filterwismanbulan') }}">
            <div class="row">
                <div class="col-lg-4">
        ...
        <div class="card">
            <div class="card-header">
                <a style="text-align: center; text-transform: uppercase;" class="btn btn-outline-success btn-sm" href="{{ route("admin.kunjunganakomodasi.createwisnu") }}">
                    Tambah Data
                </a>
            </div>
                ...
                <tbody>
                    @foreach ($kunjungan as $tanggal => $dataTanggal)
                        <tr>
                            ...
                            <td>
                                <a style="text-align: center; text-transform: uppercase;" class="btn btn-info btn-sm" href="{{ route('admin.kunjunganakomodasi.edit', ['akomodasi_id' => $hash->encode($akomodasi->id),'tanggal_kunjungan' => $tanggal]) }}">
                                    <i class="fas fa-pencil-alt"></i> Ubah
                                </a>
                                <a style="text-align: center; text-transform: uppercase;" href="{{ route('admin.kunjunganakomodasi.delete', ['akomodasi_id' => $hash->encode($akomodasi->id), 'tanggal_kunjungan' => $tanggal]) }}"
