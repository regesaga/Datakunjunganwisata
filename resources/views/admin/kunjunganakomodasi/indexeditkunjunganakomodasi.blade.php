            ...
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <select name="categoryakomodasi_id" class="form-control select2">
                        <option value="">Semua Tempat Akomodasi</option>
                        @foreach($kategoriAkomodasi as $kategori)
                            <option value="{{ $kategori->id }}" {{ request('categoryakomodasi_id') == $kategori->id ? 'selected' : '' }}>{{ $kategori->category_name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-lg-3">
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th rowspan="3" style="text-align: center;">Akomodasi</th>
                    ...
                    <tbody>
                        @forelse ($kunjungan as $dataTanggal)
                            <tr>
                                ...
                                {{ $dataTanggal['akomodasi']->namaakomodasi }}
                                </a>
                                <td>
