    ...
    <div class="container-fluid">
        ...
        <form method="GET" action="{{ route('admin.kunjunganakomodasi.index') }}">
            <div class="row">
                ...
                <select name="categoryakomodasi_id" class="form-control">
                    <option value="">Semua Tempat Akomodasi</option>
                    @foreach($kategoriAkomodasi as $kategori)
                        <option value="{{ $kategori->id }}" {{ $categoryakomodasi_id == $kategori->id ? 'selected' : '' }}>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    @foreach ($kunjungan as $dataTanggal)
                        <tr>
                            <td>{{ $dataTanggal['akomodasi']->namaakomodasi }}</td>
                            <td>
