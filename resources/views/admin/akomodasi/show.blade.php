                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <a class="btn btn-default" href="{{ route('admin.akomodasi.index') }}">
                                        Kembali
                                    </a>
                                    <a class="btn btn-outline-primary" href="{{ route('admin.akomodasi.edit', $hash->encodeHex($akomodasi->id)) }}">
                                        Edit  
                                    </a>
                                </div>
                            </div>
...
<script>
  ...
  $('.datatable-ShowAkomodasi:not(.ajaxTable)').DataTable({ buttons: dtButtons })
