            ...
            <div class="animated fadeIn">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route("admin.akomodasi.update", $hash->encodeHex($akomodasi->id)) }}"   enctype="multipart/form-data" >
                                @method('PUT')
                                @csrf
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="form-control" name="company_id" required>
                                                                                <option value="{{ $akomodasi->company_id }}" selected>{{ $akomodasi->company->nama }}</option>
                                                                                @foreach ($company as $companyItem)
                                                                                    @if ($companyItem->user && $companyItem->user->roles)
                                                                                        @foreach ($companyItem->user->roles as $role)
                                                                                        @if ($role->name === 'akomodasi' || $role->name === 'wisata')
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="active" class="form-control" required>
                                                                                <option value="1" {{ $akomodasi->active == '1' ? 'selected':'' }}>Publish</option>
                                                                                <option value="0" {{ $akomodasi->active == '0' ? 'selected':'' }}>Draft</option>
                                                                            </select>
                                                                            
                                                                            <p class="text-danger">{{ $errors->first('active') }}</p>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="categoryakomodasi_id">Kategori</label>
                                                                            ...
                                                                            <p class="text-danger">{{ $errors->first('categoryakomodasi_id') }}</p>
                                                                        </div>
                                                                        <div class="form-group">
...
Dropzone.options.photosDropzone = {
    url: '{{ route('admin.akomodasi.storeMedia') }}',
    maxFilesize: 2, // MB
