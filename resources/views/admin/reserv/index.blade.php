    ...
    <div class="col-lg-12">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class=" table table-bordered table-striped table-hover datatable datatable-reserv">
                        <thead>
                            <tr>
                                <th>
                                    Pilih
                        ...
                        <tbody>
                            @foreach($reserv as $key => $reserv)
                                <tr data-entry-id="{{ $reserv->id }}" >
                                    ...
                                    <td>
                                        <a href="{{ route('admin.reserv.byakomodasi', $hash->encodeHex($reserv->id)) }}"> {{ $reserv->akomodasi->namaakomodasi ?? '' }}</a>
...
<script>
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.reserv.massDestroy') }}",
  ...
  $('.datatable-reserv:not(.ajaxTable)').DataTable({ buttons: dtButtons })
