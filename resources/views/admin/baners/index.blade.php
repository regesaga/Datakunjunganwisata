...
<div class="col-lg-12" >
    <div class="card" >
            ...
            <div class="card-body">
                <a class="btn btn-success" href="{{ route("admin.baners.create") }}">
                                    ...
                                    <tr data-entry-id="{{ $banner->id }}">
                                        ...
                                        <td width="25%">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a class="btn btn-success" href="{{ route('admin.baners.show', $hash->encodeHex($banner->id)) }}"><i class="fas fa-eye"></i>
                                                    Detail</a>
