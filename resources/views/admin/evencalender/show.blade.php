        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ $evencalender->jammulai }} S.d {{ $evencalender->jamselesai }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <iframe style="height: 425px; width: 100%; position: relative; overflow: hidden;" src="https://maps.google.com/maps?q={{$evencalender->latitude}},{{$evencalender->longitude}}&output=embed"></iframe>
                    ...
                    <div class="form-group">
                        <a class="btn btn-default" href="{{ route('admin.evencalender.index') }}">
                            Kembali
                        </a>
