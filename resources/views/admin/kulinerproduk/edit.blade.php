...
<main class="main">
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route("admin.kulinerproduk.update", $hash->encodeHex($kulinerproduk->id)) }}"   enctype="multipart/form-data" >
                    @method('PUT')
                    @csrf
                                            ...
                                            <div class="col-lg-2 col-md-2">
                                                ...
                                                <div >
                                                    <select class="form-control" name="kuliner_id" value="{{ old('kuliner_id') }}" required>
                                                        <option value="{{$kulinerproduk->kuliner_id}}"  {{ $kulinerproduk->kuliner_id!= "" ? 'selected' : '' }}>{{$kulinerproduk->kuliner->namakuliner}}</option>
