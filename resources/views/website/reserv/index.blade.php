        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class=" scrollto" href="{{ route('website.akomodasi') }}">{{ __('messages.culinary') }}</a>
                    </li>
                    <li><a class=" scrollto"
    ...
    <main id="main">
        ...
        <section id="destinasi" class="destinasi">
            <div class="container">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Reservasi {{$akomodasi->namaakomodasi}}</h3>
                    </div>
                                ...
                                <div class="bd-example-snippet bd-code-snippet mb-5">
                                    <div class="bd-example m-0 border-0">
                                      ...
                                      <div class="row overflow-auto px-2" id="tickets" style="max-height:280px ">
                                        @foreach ($room as $index => $room)
                                                      
                                          <div class="callout callout-primary p-3 my-2 ">
                                                        <div class="row" style="padding-top: 0px">
                                                            <div class="col-3">
                                                              <p class="tix-cat">{{$room->nama }}</p>
                                                              <div class="portfolio-details-slider swiper">
                                                                <div class="swiper-wrapper align-items-center">
                                                                    @foreach ($room->photos as $key => $media)
                                                                        <div class="swiper-slide">
                                                                            <a href="{{ $media->getUrl() }}" target="_blank">
                                                                            <img src="{{ $media->getUrl('thumb') }}"  style="border-radius: 10px;" class="uwaw img-rooms-mobile" width="50px" height="50px">
                                                                            </a>
                                                                        </div>
                                                                    @endforeach
                                                                </div>
                                                            ...
                                                            <div class="col-3">
                                                                <strong style="font-size: 14px;" class="text-dark">Rp. {{ number_format($room->harga, 0, ".", ".") }},- </strong>
                                                                <input type="hidden" name="room_id[]"class="form-control" required value="{{ $room->id }}" readonly>
                                                                <input type="hidden" class="form-control" name="nama[]" required value="{{ $room->nama }}" readonly>
                                                                <input type="hidden" name="harga[]" class="form-control" required value="{{ $room->harga }}" readonly>
                                                            </div>
                                                            <div class="col-6">
                                ...
                                <div class="col-md-4">
                                    <div class="card card-primary" style="padding: 10px">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                            <input type="hidden" name="akomodasi_id"class="form-control" required value="{{ $akomodasi->id }}" readonly>
                                            <input type="hidden" name="namaakomodasi"class="form-control" required value="{{ $akomodasi->namaakomodasi }}" readonly>

                                                <label>Total Jumlah</label>
                                                <input type="number" id="totalJumlah" class="form-control" readonly>
                                            </div>
                                            <div class="col-lg-6">
...
crossorigin="anonymous"></script>
  ...
  function submitForm() {
    ...
    var formData = {
        _token: '{{ csrf_token() }}',
        akomodasi_id: $('input[name="akomodasi_id"]').val(),
        namaakomodasi: $('input[name="namaakomodasi"]').val(),
        ...
        room_id: $('input[name="room_id[]"]').map(function(){ return this.value; }).get(),
    ...
    $.post("{{ route('reserv.store') }}", formData)
        .done(function(data) {
                ...
                if (formData.metodepembayaran === 'Online') {
                    snap.pay(data.snap_token, {
                        onSuccess: function(result) {
                            ...
                            window.location.href = "{{ route('website.reserv.checkout_finish', ['reserv' => ':kodeboking']) }}".replace(':kodeboking', data.kodeboking);
                        },
