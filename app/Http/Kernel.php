...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\BlockDebugParameters::class,
    ];
    ...
    protected $routeMiddleware = [
       ...
       // 'role' => \Spatie\Permission\Middlewares\RoleMiddleware::class,
        ...
        'wisata' => \App\Http\Middleware\WisataMiddleware::class,
        'guide' => \App\Http\Middleware\GuideMiddleware::class,
        'kuliner' => \App\Http\Middleware\KulinerMiddleware::class,
        'akomodasi' => \App\Http\Middleware\AkomodasiMiddleware::class,
        'ekraf' => \App\Http\Middleware\EkrafMiddleware::class,
