...
{
    public function HomeDataKunjungan(Request $request)
        {
            ...
            foreach ($targetKunjungan as $target) {
                ...
                $semuakunjungan[] = [
                    ...
                    'selisih' => $totalKunjungan - $target->target_kunjungan_wisata
                        ...
                        return view('HomeDataKunjungan', compact('negaraData','jumlah_userwisata','jumlah_userakomodasi','jumlah_userkuliner','semuakunjungan',
...
public function rekapsemua(Request $request)
{
    ...
    return view('rekapsemua', compact('kunjungan', 'kelompok', 'wismannegara', 'kategori', 'tahun', 'wisata', 'akomodasi', 'kuliner','event'));
}
...
public function rekapsemuabulan(Request $request)
{
    ...
    return view('rekapsemuabulan', compact(
...
public function realtimes(Request $request)
{
    $hash = new Hashids();
        // Mengambil semua kelompok dan negara untuk ditampilkan di table
        $kelompok = KelompokKunjungan::all();
