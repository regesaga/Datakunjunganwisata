    ...
    public function indexkunjungankulinerpertahun(Request $request)
        {
            $hash = new Hashids();
            $company_id = auth()->user()->company->id;
            $kuliner = Kulinner::where('company_id', $company_id)->first();
    ...
    {
        {
            ...
            return view('account.kuliner.kunjungankuliner.filterwisnubulan', compact('kunjungan','kuliner','kelompok', 'hash', 'bulan', 'tahun','tanggal_kunjungan'));
        }
    }
    ...
    {
        {
            ...
            return view('account.kuliner.kunjungankuliner.filterwismanbulan', compact('kunjungan','kuliner', 'wismannegara', 'hash', 'bulan', 'tahun','tanggal_kunjungan'));
        }
    }
